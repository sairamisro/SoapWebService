 ...
 * 
 */
@WebServiceClient(name = "Calculator", targetNamespace = "http://tempuri.org/", wsdlLocation = "/wsdl/calculator.wsdl")
    ...
    extends Service
{
    ...
    static {
        CALCULATOR_WSDL_LOCATION = org.tempuri.Calculator.class.getResource("/wsdl/calculator.wsdl");
        WebServiceException e = null;
        if (CALCULATOR_WSDL_LOCATION == null) {
            e = new WebServiceException("Cannot find '/wsdl/calculator.wsdl' wsdl. Place the resource correctly in the classpath.");
        }
